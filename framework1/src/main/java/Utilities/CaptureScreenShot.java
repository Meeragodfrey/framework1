...
public class CaptureScreenShot {
	...
	public void captureScreenshotFailedTestCases(WebDriver driver, String name) throws IOException {
		...
		if (!f1.exists()) {
			f1.mkdirs();// mkdir make directory--> will create folder using java
		}
